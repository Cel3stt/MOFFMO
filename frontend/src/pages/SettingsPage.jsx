...
const PREVIEW_MESSAGES = [
  ...
  {id:2, text: "I'm good, thanks for asking!", isSent:true},
]
    ...
    <div className="h-screen container mx-auto px-4 pt-23 max-w-6xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">Choose your preferred chat design</p>
        </div>
            ...
            >
              ...
              <div className="relative h-8 w-full rounded-md overflow-hidden" data-theme={t}>
                <div className="absolute inset-0 grid grid-cols-4 gap-px p-1">
                  ...
                  <div className="rounded bg-acccent"></div>
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Momo Doe</h3>
